...
public class Telemetry {
  ...
  public void telemeterize(SwerveDriveState state) {
    ...
    for (int i = 0; i < 4; ++i) {
      ...
      m_moduleTargetsArray[i * 2 + 0] = MathUtil.angleModulus(state.ModuleTargets[i].angle.getRadians());
      ;
      m_moduleTargetsArray[i * 2 + 1] = state.ModuleTargets[i].speedMetersPerSecond;
    }
    SmartDashboard.putNumber("DriveState/TargetAngle",
        MathUtil.angleModulus(state.ModuleTargets[0].angle.getRadians()));
    SmartDashboard.putNumber("DriveState/ActualAngle", MathUtil.angleModulus(state.ModuleStates[0].angle.getRadians()));
